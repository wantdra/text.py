...
5. Admin girişi için normal login formunu (`/login`) kullanın; admin rolüne sahip kullanıcı giriş yaptığında menüde "Admin" bağlantısı otomatik görünür ve `/admin` paneline erişebilir.
